  ...
  function sendAjaxForm(mainform, url) {
    $.ajax({
      ...
      success: function success(response) {
        var alertSuccess = document.querySelector('.alert__success');
        var popupThanks = document.querySelector('.popup-thanks');
        var nameField = document.querySelector('.name-field');
        var enterField = document.querySelector('.enter-field');
        var enterFieldArea = document.querySelector('.enter-field-area');
...
$(document).ready(function () {
  ...
  function sendAjaxForm(footerform, url) {
    $.ajax({
      ...
      success: function success(response) {
        var alertSuccessFooter = document.querySelector('.alert__success-footer');
        var fieldPlace = document.querySelector('.field__place');
        alertSuccessFooter.classList.add('add_alert_shift-footer');
        fieldPlace.value = '';
      },
      error: function error(response) {
        var alertErrorFooter = document.querySelector('.alert__error-footer');
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/validation.js"], null)
